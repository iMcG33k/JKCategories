...
/// 获取指定xib中的第index个view
+ (UIView *)loadViewFromXibName:(NSString *)xibName index:(NSInteger )index {
    return [[[NSBundle mainBundle] loadNibNamed:xibName owner:self options:nil] objectAtIndex:index];
}
